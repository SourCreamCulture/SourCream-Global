...
module.exports = {
  ...
  run: async function (client, message, args) {
   ...
   var serverQueue = message.client.queue.get(message.guild.id);
    ...
    if (!song){
      if (!online.afk) {
        sendError("Leaving the voice channel because I think there are no songs in the queue. If you like the bot stay 24/7 in voice channel run `_afk`\n\nThank you for using my bot! [Bot Website](https://sourcreambot.xyz)", message.channel)

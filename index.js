...
let embed8 = new Discord.MessageEmbed()
            ...
            .setDescription('All the commands of this discord bot!')
            .addField("_kick - to kick a user")
            .addField("_ban - to ban a user")
            .addField("_urban <thing> - to search the urban dictionary")
            .addField("_cases <country> - to see the coronavirus stats of a country")
            .addField("_stock <stock symbol> - to see stock information")
            .addField("_lockdown <on> or <off> - to lock or unlock the server")
            .addField("_helpm - to see the music commands for the bot")
            .addField("_updates - to see the recent updates made to the bot!")
            .addField("_ping - to see the bots ping")
            .addField("_uptime - to see the bots uptime")
            .addField("_docs - provides a link to the discord.js docs")
            .addField("_setup - to setup the discord server to work with the welcome and global chat features!");
...
if (pileface === 0) {
message.channel.send("You just got : **Battery** !")
return message.channel.send("🎉**You won**🎉 **Bravos to you friend** !")
} else {
message.channel.send("You just got : **Face** !")
